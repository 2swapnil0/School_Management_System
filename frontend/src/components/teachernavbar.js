...
const Sidebar = ({ open, onClose }) => (
  ...
  >
    ...
    >
      <ListItemButton sx={{ fontWeight: 'lg' }} component={Link} to="/teacherdashboard">
        Home
      </ListItemButton>
      <ListItemButton component={Link} to="/classes">
        Schedule Classes
      </ListItemButton>
      <ListItemButton sx={{ fontWeight: 'lg' }} component={Link} to="/assignment">
        Assignment
      </ListItemButton>
      <ListItemButton sx={{ fontWeight: 'lg' }} component={Link} to="/addgrades">
        Gradebook
      </ListItemButton>
    </List>
  </Drawer>
