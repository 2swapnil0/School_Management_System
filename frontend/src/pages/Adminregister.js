...
const AdminRegister = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    setLoader(true); // Set loader to true during registration

    try {
      // Make POST request to register admin
      ...
      setMessage("Failed to register admin. Please try again."); // Set error message
    } finally {
      setLoader(false); // Set loader to false after registration attempt
  ...
  // JSX for the admin registration form
  return (
